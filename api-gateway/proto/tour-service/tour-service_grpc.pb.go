...
type TourServiceClient interface {
	...
	GetTourByAuthorId(ctx context.Context, in *AuthorRequest, opts ...grpc.CallOption) (*PagedTourList, error)
	// TourKeyPoints
...
func (c *tourServiceClient) GetTourByAuthorId(ctx context.Context, in *AuthorRequest, opts ...grpc.CallOption) (*PagedTourList, error) {
	out := new(PagedTourList)
...
type TourServiceServer interface {
	...
	GetTourByAuthorId(context.Context, *AuthorRequest) (*PagedTourList, error)
	// TourKeyPoints
...
func (UnimplementedTourServiceServer) GetTourByAuthorId(context.Context, *AuthorRequest) (*PagedTourList, error) {
