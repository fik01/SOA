...
func Route(router *mux.Router, handler *handler.Handler) {
	...
	router.HandleFunc("/blog/blogComments", handler.BlogHandler.GetAll).Methods("GET")
	router.HandleFunc("/blog/createComment", handler.BlogHandler.Create).Methods("POST")
}